...
- View channel details and channel-related content
- Search for videos and view search results

**Tech Stack**
- React 18
- React Router DOM (v6) for client-side routing
- Material UI (MUI) for layout, components and icons
...
- Channel detail page
- Search functionality with routed results
